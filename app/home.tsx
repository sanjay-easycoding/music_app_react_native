        ...
        {showMenu && (
          <>
            ...
            <View style={styles.menuButtons}>
              <TouchableOpacity style={styles.menuBtn} activeOpacity={0.85} onPress={() => router.push('/qrcode')}>
              ...
              <TouchableOpacity style={styles.menuBtn} activeOpacity={0.85} onPress={() => router.push('/qrcode2')}>
                <MaterialCommunityIcons name="qrcode-scan" size={26} color="#fff" />
                <Text style={styles.menuBtnText}>Join Game</Text>
                <Ionicons name="chevron-forward" size={22} color="#fff" style={styles.menuBtnArrow} />
              </TouchableOpacity>

              <TouchableOpacity style={styles.menuBtn} activeOpacity={0.85} onPress={() => router.push('/leaderboard')}>
                <FontAwesome5 name="trophy" size={22} color="#fff" />
                <Text style={styles.menuBtnText}>Leaderboard</Text>
                <Ionicons name="chevron-forward" size={22} color="#fff" style={styles.menuBtnArrow} />
              </TouchableOpacity>

              <TouchableOpacity style={styles.menuBtn} activeOpacity={0.85} onPress={() => router.push('/profile')}>
                <Ionicons name="person-circle" size={26} color="#fff" />
                <Text style={styles.menuBtnText}>Profile</Text>
                <Ionicons name="chevron-forward" size={22} color="#fff" style={styles.menuBtnArrow} />
              </TouchableOpacity>

              <TouchableOpacity style={styles.menuBtn} activeOpacity={0.85} onPress={() => router.push('/settings')}>
